-- AI LogFixer integration state owned by Control One.
--
-- Control One keeps tenancy, approval, job, audit, and receipt ownership here
-- while AI LogFixer remains the owner of the versioned diagnosis/remediation
-- contract payloads stored in the JSONB columns.
