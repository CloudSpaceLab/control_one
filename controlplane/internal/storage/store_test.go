...
func setupPostgresStore(t *testing.T, ctx context.Context) *Store {
	...
	pg, err := postgres.Run(ctx, "docker.io/postgres:16-alpine",
		postgres.WithInitScripts(
			...
			"../migrate/sql/0008_policies.up.sql",
			"../migrate/sql/0016_enrollment_tokens.up.sql",
			"../migrate/sql/0022_nodes_machine_id.up.sql",
			"../migrate/sql/0025_clusters.up.sql",
			"../migrate/sql/0026_cluster_members.up.sql",
			"../migrate/sql/0028_node_lifecycle.up.sql",
			"../migrate/sql/0033_provider_credentials.up.sql",
			"../migrate/sql/0034_hypervisor_hosts.up.sql",
			"../migrate/sql/0111_policy_template_scopes.up.sql",
		),
