...
function RequestForm({ tenantId, onCreated }) {
    ...
    return (_jsxs("form", { onSubmit: submit, style: { display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '0.5rem', alignItems: 'end' }, children: [_jsxs("label", { children: ["Type", _jsxs("select", { value: form.target_resource_type, onChange: (e) => setForm({ ...form, target_resource_type: e.target.value }), children: [_jsx("option", { value: "ssh", children: "ssh" }), _jsx("option", { value: "rdp", children: "rdp" }), _jsx("option", { value: "db", children: "db" })] })] }), _jsxs("label", { children: ["Access", _jsx("input", { required: true, value: form.requested_access, onChange: (e) => setForm({ ...form, requested_access: e.target.value }) })] }), _jsxs("label", { style: { gridColumn: 'span 2' }, children: ["Justification", _jsx("input", { value: form.justification ?? '', onChange: (e) => setForm({ ...form, justification: e.target.value }) })] }), _jsxs("label", { children: ["TTL (s)", _jsx("input", { type: "number", min: 60, value: form.ttl_seconds ?? 1800, onChange: (e) => setForm({ ...form, ttl_seconds: Number(e.target.value) }) })] }), _jsx("button", { type: "submit", className: "primary-button", disabled: submitting, style: { gridColumn: 'span 5' }, children: "Request access" })] }));
}
