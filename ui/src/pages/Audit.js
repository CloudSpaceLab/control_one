...
export function Audit() {
    ...
    return (_jsxs("div", { className: "audit-page", children: [_jsxs("div", { className: "page-header", children: [_jsxs("div", { children: [_jsx("h1", { children: "Audit Log" }), _jsx("p", { className: "subtitle", children: "View and search audit trail of all system activities" })] }), _jsxs("div", { className: "page-actions", children: [_jsx("button", { type: "button", onClick: handleRefresh, className: "btn-secondary", children: "Refresh" }), _jsx("button", { type: "button", onClick: handleExport, className: "btn-primary", disabled: logs.length === 0, children: "Export CSV" })] })] }), _jsxs("div", { className: "filters-section", children: [_jsxs("div", { className: "filter-group", children: [_jsx("label", { htmlFor: "tenant-filter", children: "Tenant" }), _jsxs("select", { id: "tenant-filter", value: selectedTenant || '', onChange: (e) => {
