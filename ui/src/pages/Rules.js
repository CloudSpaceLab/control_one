...
function PortRulesPane({ tenantId, rules, onRefresh, }) {
    ...
    return (_jsxs("div", { children: [_jsx(ConfirmModal, { open: confirmDeleteId !== null, title: "Delete port rule?", body: "This cannot be undone.", variant: "danger", confirmLabel: "Delete", onConfirm: () => {
                    if (confirmDeleteId)
                        remove(confirmDeleteId);
                    setConfirmDeleteId(null);
                }, onCancel: () => setConfirmDeleteId(null) }), _jsxs("form", { className: "form-row", onSubmit: submit, style: { display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '0.5rem', alignItems: 'end' }, children: [_jsxs("label", { htmlFor: "pr-name", children: ["Name", _jsx("input", { id: "pr-name", required: true, value: form.name, onChange: (e) => setForm({ ...form, name: e.target.value }) })] }), _jsxs("label", { htmlFor: "pr-port", children: ["Port", _jsx("input", { id: "pr-port", type: "number", min: 1, max: 65535, required: true, value: form.port, onChange: (e) => setForm({ ...form, port: Number(e.target.value) }) })] }), _jsxs("label", { htmlFor: "pr-protocol", children: ["Protocol", _jsxs("select", { id: "pr-protocol", value: form.protocol, onChange: (e) => setForm({ ...form, protocol: e.target.value }), children: [_jsx("option", { value: "tcp", children: "tcp" }), _jsx("option", { value: "udp", children: "udp" })] })] }), _jsxs("label", { htmlFor: "pr-expected", children: ["Expected", _jsxs("select", { id: "pr-expected", value: form.expected_state, onChange: (e) => setForm({ ...form, expected_state: e.target.value }), children: [_jsx("option", { value: "closed", children: "closed" }), _jsx("option", { value: "open", children: "open" })] })] }), _jsxs("label", { htmlFor: "pr-severity", children: ["Severity", _jsxs("select", { id: "pr-severity", value: form.severity, onChange: (e) => setForm({ ...form, severity: e.target.value }), children: [_jsx("option", { value: "low", children: "low" }), _jsx("option", { value: "medium", children: "medium" }), _jsx("option", { value: "high", children: "high" }), _jsx("option", { value: "critical", children: "critical" })] })] }), _jsx("button", { type: "submit", className: "primary-button", disabled: submitting, children: "Add rule" })] }), _jsxs("table", { className: "data-table", style: { marginTop: '1rem', width: '100%' }, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Name" }), _jsx("th", { children: "Port" }), _jsx("th", { children: "Proto" }), _jsx("th", { children: "Expected" }), _jsx("th", { children: "Severity" }), _jsx("th", { children: "Enabled" }), _jsx("th", {})] }) }), _jsx("tbody", { children: rules.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 7, className: "muted", children: "No port rules yet." }) })) : (rules.map((r) => (_jsxs("tr", { children: [_jsx("td", { children: r.name }), _jsx("td", { children: r.port }), _jsx("td", { children: r.protocol }), _jsx("td", { children: r.expected_state }), _jsx("td", { children: r.severity }), _jsx("td", { children: r.enabled ? 'yes' : 'no' }), _jsx("td", { children: _jsx("button", { type: "button", className: "secondary-button", onClick: () => setConfirmDeleteId(r.id), children: "Delete" }) })] }, r.id)))) })] })] }));
}
function LogRulesPane({ tenantId, rules, onRefresh, }) {
    ...
    return (_jsxs("div", { children: [_jsx(ConfirmModal, { open: confirmDeleteId !== null, title: "Delete log rule?", body: "This cannot be undone.", variant: "danger", confirmLabel: "Delete", onConfirm: () => {
                    if (confirmDeleteId)
                        remove(confirmDeleteId);
                    setConfirmDeleteId(null);
                }, onCancel: () => setConfirmDeleteId(null) }), _jsxs("form", { className: "form-row", onSubmit: submit, style: { display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '0.5rem', alignItems: 'end' }, children: [_jsxs("label", { htmlFor: "lr-name", children: ["Name", _jsx("input", { id: "lr-name", required: true, value: form.name, onChange: (e) => setForm({ ...form, name: e.target.value }) })] }), _jsxs("label", { htmlFor: "lr-source", children: ["Source", _jsx("input", { id: "lr-source", required: true, value: form.log_source, onChange: (e) => setForm({ ...form, log_source: e.target.value }) })] }), _jsxs("label", { htmlFor: "lr-pattern", style: { gridColumn: 'span 2' }, children: ["Pattern (regex)", _jsx("input", { id: "lr-pattern", required: true, value: form.pattern, onChange: (e) => setForm({ ...form, pattern: e.target.value }) })] }), _jsxs("label", { htmlFor: "lr-window", children: ["Window (s)", _jsx("input", { id: "lr-window", type: "number", min: 1, value: form.window_seconds, onChange: (e) => setForm({ ...form, window_seconds: Number(e.target.value) }) })] }), _jsxs("label", { htmlFor: "lr-threshold", children: ["Threshold", _jsx("input", { id: "lr-threshold", type: "number", min: 1, value: form.threshold, onChange: (e) => setForm({ ...form, threshold: Number(e.target.value) }) })] }), _jsx("button", { type: "submit", className: "primary-button", disabled: submitting, children: "Add rule" })] }), _jsxs("table", { className: "data-table", style: { marginTop: '1rem', width: '100%' }, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Name" }), _jsx("th", { children: "Source" }), _jsx("th", { children: "Pattern" }), _jsx("th", { children: "Win" }), _jsx("th", { children: "Thresh" }), _jsx("th", { children: "Sev" }), _jsx("th", {})] }) }), _jsx("tbody", { children: rules.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 7, className: "muted", children: "No log rules yet." }) })) : (rules.map((r) => (_jsxs("tr", { children: [_jsx("td", { children: r.name }), _jsx("td", { children: r.log_source }), _jsx("td", { children: _jsx("code", { children: r.pattern }) }), _jsxs("td", { children: [r.window_seconds, "s"] }), _jsx("td", { children: r.threshold }), _jsx("td", { children: r.severity }), _jsx("td", { children: _jsx("button", { type: "button", className: "secondary-button", onClick: () => setConfirmDeleteId(r.id), children: "Delete" }) })] }, r.id)))) })] })] }));
}
