...
export function Compliance() {
    ...
    const { data: trends, loading: trendsLoading, error: trendsError, } = useComplianceTrends({
        tenant_id: selectedTenant,
        node_id: selectedNode,
        days: 30,
    });
    ...
    return (_jsxs("div", { className: "compliance-page", children: [_jsxs("div", { className: "page-header", children: [_jsxs("div", { children: [_jsx("h1", { children: "Compliance Dashboard" }), _jsx("p", { className: "subtitle", children: "Monitor compliance status, violations, and trends across your infrastructure" })] }), _jsxs("div", { className: "page-actions", children: [_jsx("button", { type: "button", onClick: handleRefresh, className: "btn-secondary", children: "Refresh" }), _jsx("button", { type: "button", onClick: handleExport, className: "btn-primary", disabled: results.length === 0, children: "Export CSV" })] })] }), _jsxs("div", { className: "filters-section", children: [_jsxs("div", { className: "filter-group", children: [_jsx("label", { htmlFor: "tenant-filter", children: "Tenant" }), _jsxs("select", { id: "tenant-filter", value: selectedTenant || '', onChange: (e) => {
